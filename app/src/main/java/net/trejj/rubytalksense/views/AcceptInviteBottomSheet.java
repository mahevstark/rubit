package net.trejj.rubytalksense.views;
...
import net.trejj.rubytalksense.adapters.PartialGroupUsersAdapter;
...
public class AcceptInviteBottomSheet extends BottomSheetDialogFragment {
    ...
    public void showData(User user, int usersCount) {
        ...
        net.trejj.rubytalksense.model.realms.Group group = user.getGroup();
        if (group != null) {
