...
public class GroupEvent extends RealmObject implements Parcelable {
    ...
    public void createGroupEvent(net.trejj.rubytalksense.model.realms.User group, String eventId) {
        net.trejj.rubytalksense.model.realms.Message message = new Message();
    ...
    public static String extractString(String messageContent, RealmList<net.trejj.rubytalksense.model.realms.User> users) {
        try {
    ...
    private static String getUserNameFromGroupEvent(String number, RealmList<net.trejj.rubytalksense.model.realms.User> users) {
