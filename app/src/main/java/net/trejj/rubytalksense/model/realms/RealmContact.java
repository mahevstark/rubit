...
public class RealmContact extends RealmObject implements Parcelable {
    ...
    private RealmList<net.trejj.rubytalksense.model.realms.PhoneNumber> realmList;


    public RealmContact() {
    }

    public RealmContact(String name, ArrayList<net.trejj.rubytalksense.model.realms.PhoneNumber> numbers) {
        this.name = name;
    ...
    public RealmList<net.trejj.rubytalksense.model.realms.PhoneNumber> getRealmList() {
        return realmList;
    }

    public HashMap<String, Boolean> toMap() {
        HashMap<String, Boolean> numbers = new HashMap<>();
        for (net.trejj.rubytalksense.model.realms.PhoneNumber phoneNumber : realmList) {
