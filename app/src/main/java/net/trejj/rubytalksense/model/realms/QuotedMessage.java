...
public class QuotedMessage extends RealmObject {
    ...
    private net.trejj.rubytalksense.model.realms.RealmContact contact;
    //when sending or receiving a location
    private RealmLocation location;
    private boolean isBroadcast;

    private net.trejj.rubytalksense.model.realms.Status status;

    public net.trejj.rubytalksense.model.realms.Status getStatus() {
        return status;
    }
    ...
    public static net.trejj.rubytalksense.model.realms.Message quotedMessageToMessage(QuotedMessage quotedMessage) {
        net.trejj.rubytalksense.model.realms.Message message = new net.trejj.rubytalksense.model.realms.Message();
    ...
    public net.trejj.rubytalksense.model.realms.RealmContact getContact() {
        return contact;
    }
