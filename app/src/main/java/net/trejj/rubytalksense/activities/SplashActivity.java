...
import net.trejj.rubytalksense.activities.AgreePrivacyPolicyActivity;
import net.trejj.rubytalksense.activities.authentication.AuthenticationActivity;
import net.trejj.rubytalksense.activities.main.MainActivity;
import net.trejj.rubytalksense.activities.setup.SetupUserActivity;
import net.trejj.rubytalksense.utils.DetachableClickListener;
import net.trejj.rubytalksense.utils.network.FireManager;
import net.trejj.rubytalksense.utils.PermissionsUtil;
