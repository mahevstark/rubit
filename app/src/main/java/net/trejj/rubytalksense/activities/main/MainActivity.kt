package net.trejj.rubytalksense.activities.main
...
import net.trejj.rubytalksense.activities.*
import net.trejj.rubytalksense.activities.settings.SettingsActivity
import net.trejj.rubytalksense.adapters.ViewPagerAdapter
import net.trejj.rubytalksense.common.ViewModelFactory
import net.trejj.rubytalksense.common.extensions.findFragmentByTagForViewPager
import net.trejj.rubytalksense.events.ExitUpdateActivityEvent
import net.trejj.rubytalksense.events.NavigateToLockActivity
import net.trejj.rubytalksense.fragments.BaseFragment
import net.trejj.rubytalksense.interfaces.FragmentCallback
...
import net.trejj.rubytalksense.job.SetLastSeenJob
import net.trejj.rubytalksense.model.realms.User
import net.trejj.rubytalksense.services.*
import net.trejj.rubytalksense.utils.*
import net.trejj.rubytalksense.utils.network.FireManager
import net.trejj.rubytalksense.views.dialogs.IgnoreBatteryDialog
