...
package net.trejj.rubytalksense.activities.calling
...
import net.trejj.rubytalksense.activities.calling.event.CallingStateEvent
import net.trejj.rubytalksense.activities.calling.event.CallingViewState
import net.trejj.rubytalksense.activities.calling.model.CallType
import net.trejj.rubytalksense.activities.calling.model.CallingState
import net.trejj.rubytalksense.activities.calling.model.EngineConfig
import net.trejj.rubytalksense.common.extensions.unBindServiceSafely
import net.trejj.rubytalksense.extensions.finishAndRemoveTaskCompat
import net.trejj.rubytalksense.model.ImageItem
...
import net.trejj.rubytalksense.utils.network.FireManager.Companion.checkAndDownloadUserPhoto
import net.trejj.rubytalksense.utils.network.FireManager.Companion.fetchUserByUid
    ...
    fun updateState(callingViewState: CallingViewState) {
        when (callingViewState) {
            ...
            is CallingViewState.UpdateCallingState -> {
                ...
                Log.e("Calling Failed", callingViewState.callingState.toString());
