package net.trejj.rubytalksense.activities.main.status
...
import net.trejj.rubytalksense.activities.MyStatusActivity
import net.trejj.rubytalksense.activities.ViewStatusActivity
import net.trejj.rubytalksense.activities.main.MainActivity.Companion.CAMERA_REQUEST
import net.trejj.rubytalksense.activities.main.MainActivity.Companion.REQUEST_CODE_TEXT_STATUS
import net.trejj.rubytalksense.activities.main.MainViewModel
import net.trejj.rubytalksense.activities.main.status.StatusFragmentEvent.OnActivityResultEvent
import net.trejj.rubytalksense.activities.main.status.StatusFragmentEvent.StatusInsertedEvent
import net.trejj.rubytalksense.adapters.StatusAdapter
import net.trejj.rubytalksense.fragments.BaseFragment
import net.trejj.rubytalksense.interfaces.StatusFragmentCallbacks
...
import net.trejj.rubytalksense.views.HeaderViewDecoration
import net.trejj.rubytalksense.views.TextViewWithShapeBackground
