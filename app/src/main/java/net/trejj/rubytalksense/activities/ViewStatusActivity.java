...
import net.trejj.rubytalksense.adapters.StatusSeenByAdapter;
import net.trejj.rubytalksense.adapters.StatusSeenByCallback;
...
import net.trejj.rubytalksense.model.realms.StatusSeenBy;
...
import net.trejj.rubytalksense.utils.KeyboardUtils;
...
import net.trejj.rubytalksense.utils.StatusHelper;
...
import net.trejj.rubytalksense.utils.network.StatusManager;
...
import static net.trejj.rubytalksense.activities.main.messaging.ChatActivity.CAMERA_REQUEST;
import static net.trejj.rubytalksense.activities.main.messaging.ChatActivity.MAX_FILE_SIZE;
import static net.trejj.rubytalksense.activities.main.messaging.ChatActivity.PICK_CONTACT_REQUEST;
import static net.trejj.rubytalksense.activities.main.messaging.ChatActivity.PICK_GALLERY_REQUEST;
import static net.trejj.rubytalksense.activities.main.messaging.ChatActivity.PICK_LOCATION_REQUEST;
import static net.trejj.rubytalksense.activities.main.messaging.ChatActivity.PICK_MUSIC_REQUEST;
import static net.trejj.rubytalksense.activities.main.messaging.ChatActivity.PICK_NUMBERS_FOR_CONTACT_REQUEST;
import static net.trejj.rubytalksense.activities.main.messaging.ChatActivity.RECORD_START_AUDIO_LENGTH;
import static net.trejj.rubytalksense.utils.FontUtil.isFontExists;
...
//        finish();
    ...
    @Override
    public void onClick(@NonNull User user, @NonNull View itemView) {
