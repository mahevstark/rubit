...
import net.trejj.rubytalksense.model.constants.FireCallDirection;
import net.trejj.rubytalksense.model.constants.MessageStat;
import net.trejj.rubytalksense.model.constants.MessageType;
import net.trejj.rubytalksense.model.realms.Broadcast;
import net.trejj.rubytalksense.model.realms.Chat;
import net.trejj.rubytalksense.model.realms.CurrentUserInfo;
import net.trejj.rubytalksense.model.realms.DeletedMessage;
import net.trejj.rubytalksense.model.realms.FireCall;
import net.trejj.rubytalksense.model.realms.Group;
import net.trejj.rubytalksense.model.realms.JobId;
...
import net.trejj.rubytalksense.model.realms.UserStatuses;
...
public class RealmHelper {
    ...
    public void deleteMessageFromRealm(String chatId, String messageId, boolean deleteFile) {
        ...
        if (deleteFile && !messageToDelete.isTextMessage())
            net.trejj.rubytalksense.utils.FileUtils.deleteFile(messageToDelete.getLocalPath());
...
*/
    ...
    public void updateUserImg(String uid, String imgUrl, String localPath, String oldLocalPath) {
        ...
        net.trejj.rubytalksense.utils.FileUtils.deleteFile(oldLocalPath);
    ...
    public List<String> updateGroup(String groupId, DataSnapshot info, DataSnapshot usersSnapshot) {
        ...
        List<String> distinct = net.trejj.rubytalksense.utils.ListUtil.distinct(storedUids, serverUids);
        ...
        for (String uid : distinct) {
            ...
            //otherwise it's a deletion event
                ...
                //get user from group
                User userById = net.trejj.rubytalksense.utils.ListUtil.getUserById(uid, users);
                //check if exists
                if (userById != null) {
    ...
    public RealmResults<UserStatuses> getAllStatuses() {
        return realm.where(UserStatuses.class)
                ...
                .between(DBConstants.lastStatusTimestamp, net.trejj.rubytalksense.utils.TimeHelper.getTimeBefore24Hours(), Long.MAX_VALUE)
                .isNotEmpty("statuses")
                .findAll()
        ...
        if (status != null && userStatuses != null) {
            ...
            if (!userId.equals(FireManager.getUid())) {
                if (status.getLocalPath() != null)
                    net.trejj.rubytalksense.utils.FileUtils.deleteFile(status.getLocalPath());
            }
    ...
    public void updateUserStatus(@NonNull String uid, @NonNull String status) {
        User user = getUser(uid);
        if (user == null) return;
        realm.executeTransaction(transaction -> {
