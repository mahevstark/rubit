...
import net.trejj.rubytalksense.exceptions.BackupFileMismatchedException;
...
import net.trejj.rubytalksense.utils.MyMigration;
...
public class RealmBackupRestore {
    ...
    public void restore() throws IOException, BackupFileMismatchedException, RealmMigrationNeededException {
        ...
        RealmConfiguration configuration = new RealmConfiguration.Builder()
                ...
                .schemaVersion(net.trejj.rubytalksense.utils.MyMigration.SCHEMA_VERSION)
        ...
        if (currentUserInfo != null && currentUserInfo.getUid().equals(FireManager.getUid())) {
            ...
            net.trejj.rubytalksense.utils.RealmHelper instance = RealmHelper.getInstance();
