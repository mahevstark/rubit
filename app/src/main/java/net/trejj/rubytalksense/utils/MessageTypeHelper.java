    ...
    public static String getTypeText(int type) {
        switch (type) {
            ...
            case MessageType.RECEIVED_IMAGE:
                return net.trejj.rubytalksense.utils.MyApp.context().getString(R.string.photo);

            case MessageType.SENT_VIDEO:
            case MessageType.RECEIVED_VIDEO:
                return net.trejj.rubytalksense.utils.MyApp.context().getString(R.string.video);


            case MessageType.SENT_VOICE_MESSAGE:
            case MessageType.RECEIVED_VOICE_MESSAGE:
                return net.trejj.rubytalksense.utils.MyApp.context().getString(R.string.voice_message);


            case MessageType.SENT_AUDIO:
            case MessageType.RECEIVED_AUDIO:
                return net.trejj.rubytalksense.utils.MyApp.context().getString(R.string.audio);


            case MessageType.SENT_FILE:
            case MessageType.RECEIVED_FILE:
                return net.trejj.rubytalksense.utils.MyApp.context().getString(R.string.file);
