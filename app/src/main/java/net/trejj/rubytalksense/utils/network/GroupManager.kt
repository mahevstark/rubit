...
import net.trejj.rubytalksense.extensions.*
import net.trejj.rubytalksense.model.constants.DBConstants
import net.trejj.rubytalksense.model.constants.GroupEventTypes
import net.trejj.rubytalksense.model.constants.GroupEventTypes.GROUP_CREATION
import net.trejj.rubytalksense.model.constants.GroupEventTypes.USER_ADDED
                ...
                .flatMap { snapshot ->
                    ...
                    if (snapshot.exists()) {
                        for (snap in snapshot.children) {
                            ...
                            groupEvent?.let { groupEventNonNullable ->
                                //if it's a creation event
                                if (groupEventNonNullable.contextStart == groupEventNonNullable.contextEnd) {
