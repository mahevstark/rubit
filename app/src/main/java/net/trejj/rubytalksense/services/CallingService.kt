package net.trejj.rubytalksense.services
...
import net.trejj.rubytalksense.activities.calling.AgoraConfig
...
import net.trejj.rubytalksense.activities.calling.model.*
import net.trejj.rubytalksense.common.extensions.abandonAudioFocusCompat
import net.trejj.rubytalksense.common.extensions.requestAudioFocusCompat
...
import net.trejj.rubytalksense.utils.network.CallsManager
...
class CallingService : Service(), ProximitySensor.Delegate, AudioManager.OnAudioFocusChangeListener, DuringCallEventHandler {
    ...
    private fun joinChannel(channelName: String, uid: Int): Int {
        ...
        if (result == 0) {
            ...
            Log.e("ChannelStatus","ChannelJoined");
            Log.e("channelName",channelName);
        }
        else{
            Log.e("ChannelStatus","ChannelFailed");
        }
