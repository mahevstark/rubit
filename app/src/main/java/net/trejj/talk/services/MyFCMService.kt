...
import net.trejj.talk.model.realms.*
import net.trejj.talk.utils.*
import net.trejj.talk.utils.IntentUtils.NOTIFICATION_ACTION_START_INCOMING
import net.trejj.talk.utils.network.CallsManager.Companion.CALL_TIEMOUT_SECONDS
import net.trejj.talk.utils.network.FireManager
import net.trejj.talk.utils.network.FireManager.Companion.isLoggedIn
import net.trejj.talk.utils.network.FireManager.Companion.uid
import net.trejj.talk.utils.network.GroupManager
import net.trejj.talk.utils.update.UpdateChecker
