package net.trejj.talk.activities.main.status
...
import net.trejj.talk.activities.main.status.StatusFragmentEvent.OnActivityResultEvent
import net.trejj.talk.activities.main.status.StatusFragmentEvent.StatusInsertedEvent
