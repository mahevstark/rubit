...
import net.trejj.talk.activities.AgreePrivacyPolicyActivity;
import net.trejj.talk.activities.authentication.AuthenticationActivity;
import net.trejj.talk.activities.main.MainActivity;
import net.trejj.talk.activities.setup.SetupUserActivity;
import net.trejj.talk.utils.DetachableClickListener;
import net.trejj.talk.utils.network.FireManager;
import net.trejj.talk.utils.PermissionsUtil;
