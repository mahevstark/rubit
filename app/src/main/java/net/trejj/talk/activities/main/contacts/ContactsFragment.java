package net.trejj.talk.activities.main.contacts;
...
import net.trejj.talk.GetContacts;
import net.trejj.talk.R;
import net.trejj.talk.activities.main.MainActivity;
import net.trejj.talk.adapters.ContactAdapter;
...
import static net.trejj.talk.activities.main.MainActivity.fab;
import static net.trejj.talk.activities.main.MainActivity.textStatusFab;
