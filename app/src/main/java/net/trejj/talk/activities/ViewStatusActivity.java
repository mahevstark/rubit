...
import net.trejj.talk.adapters.StatusSeenByAdapter;
import net.trejj.talk.adapters.StatusSeenByCallback;
...
import net.trejj.talk.utils.KeyboardUtils;
...
import net.trejj.talk.utils.StatusHelper;
...
import static net.trejj.talk.activities.main.messaging.ChatActivity.CAMERA_REQUEST;
import static net.trejj.talk.activities.main.messaging.ChatActivity.MAX_FILE_SIZE;
import static net.trejj.talk.activities.main.messaging.ChatActivity.PICK_CONTACT_REQUEST;
import static net.trejj.talk.activities.main.messaging.ChatActivity.PICK_GALLERY_REQUEST;
import static net.trejj.talk.activities.main.messaging.ChatActivity.PICK_LOCATION_REQUEST;
import static net.trejj.talk.activities.main.messaging.ChatActivity.PICK_MUSIC_REQUEST;
import static net.trejj.talk.activities.main.messaging.ChatActivity.PICK_NUMBERS_FOR_CONTACT_REQUEST;
import static net.trejj.talk.activities.main.messaging.ChatActivity.RECORD_START_AUDIO_LENGTH;
import static net.trejj.talk.utils.FontUtil.isFontExists;
